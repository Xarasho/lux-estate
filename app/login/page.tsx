    ...
    <div className="font-display bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-4 antialiased text-nordic dark:text-gray-100 relative overflow-hidden">
      ...
      <main className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-10">
          <Link
            href="/"
            className="inline-flex items-center justify-center w-14 h-14 bg-primary rounded-xl mb-6 shadow-soft text-white hover:scale-105 transition-transform cursor-pointer"
        ...
        <div className="bg-surface dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-primary/20 backdrop-blur-sm">
          {errorMessage && (
            <div className="mb-6 p-3 rounded-lg bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900/50 text-red-600 dark:text-red-400 text-xs flex items-center gap-2">
          ...
          <p className="mt-8 text-center text-sm text-nordic/70 dark:text-gray-400">
            ...
            <button
              type="button"
              onClick={() => handleGoogleSignIn()}
              className="font-semibold text-primary hover:text-primary-dark transition-colors cursor-pointer inline"
            >
              Sign up
            </button>
          </p>
